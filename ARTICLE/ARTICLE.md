...
Adapting Frank’s model for my own, then, required working somewhat against the grain of his assumptions. However, I have avoided simply assigning each text one simple genre. Instead, I have sought to separate out each strand of influence within his complex “Gothic types”  by dividing each “type” into a set of tags, and tallied the uses of each tag. The novel A Suffolk Tale, for example, listed in Frank as “Domestic fiction (various Gothic elements)” becomes “domestic” and “Gothic elements.” Similarly, Radcliffe’s The Italian, listed as “Pure or high Gothic (terror and horror modes)” becomes “high”, “Gothic”, “terror mode”, “horror mode”, and “Radcliffean.” This process generated 45 unique tags, most of which only applied to one or two novels. [My model of the Gothic types, then, has X assumptions and priorities.] From there, my search for gendered types followed the same principles as my analysis of Tracy’s motif, asking, does the association of this tag with a work constitute meaningful information regarding the probable gender of that work’s author? [Because Frank’s classifications are subjective assessments, an answer of “yes” to this question does not necessarily indicate that [women really did write in different moves], but instead means that the critical identification of this generic element is responding to authorial gender.] [Perhaps for that reason, Frank’s Gothic types do not point toward a clear Male Gothic tradition, but do show a Female Gothic.]

## Male Gothic ##

[In Tracy, the Male Gothic was a distinct [grouping] of what seem to be horror-Gothics, outnumbered by [the Shared Gothic].] [Frank does confirm the unbalanced nature of the terror/horror binary.] The terror mode enormously outnumbers the horror mode, with 62 novels (35% of the sample) tagged “terror” and only 24 (13%) tagged “horror.” The more-popular terror mode is non-gendered (53% female, 47% male), while the horror mode tends toward male authorship (62% male). However, of those 24 novels tagged as horror, 14 were also tagged as terror, leaving a mere 10 books are pure “horror mode.” If we attempt to treat the two modes as mutually-exclusive, seaparating out the “horror-terror” mixed-mode books as a third mode, our gendered expectations fall apart: the 10 pure-horror books are precisely split between male and female authors. Instead, it is the horror-terror mode which is most predictive of male authorship (71% male). [It seems, then, that although the relative prominence of the two modes accords with our expectations based on Tracy’s, the critical identification of terror and horror does not have a basis in gendered patterns of use. ???]

## [Shared?] Gothics ##

[All kinds of schools not often accorded central importance to the Gothic, but none of them dominate.] The eleven tags which correspond to at least nine novels and their respective prevalence, from most popular to least popular, are “high Gothic” (35%), “terror” (34%), “history” (16%), “domestic” (15%), “horror” (13%), “sentimental” (13%), “Radcliffean” (10%), “chapbook” (9%), “naturalized or explained” (6%), Schauerromantik (6%), and “Monk imitation / monastic shocker” (5%). Only “high Gothic” and “terror” apply to more than a quarter of the works. [Frank doesn’t really show a unified Gothic at all.] [But it’s mainly non-gendered, and definitely doesn’t operate by binaries.]
