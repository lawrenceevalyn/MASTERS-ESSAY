...
Current study of gender and the early Gothic is sophisticated at the expense of examining few texts. This paper examines hundreds of popular Gothic works to ask whether female writers created categorically different works than their male peers. Two qualitative bibliographies of the Gothic provide “motifs” and “Gothic types” for computational modelling. In these models, male and female schools do indeed exist, but that they do not map neatly to a set of female/male terror/horror Radcliffe/Lewis binaries, and both gendered schools are dwarfed by a non-gendered Gothic mainstream.
